      ...
      <div class="page__grid">
          ...
          <div class="aside">
            <div class="aside__menu">
              <div class="aside-menu"
                   data-type="2"
              >
                <a href="https://smkis.ru/pdf/permits/iso_9001-2015.pdf"
                ...
                >
                  ...
                  >
                    <path fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M9.47059 4.5H19.5294C21.17 4.5 22.5 5.82998 22.5 7.47059V20.8824C22.5 22.523 21.17 23.8529 19.5294 23.8529H9.47059C7.82998 23.8529 6.5 22.523 6.5 20.8824V7.47059C6.5 5.82998 7.82998 4.5 9.47059 4.5ZM5 7.47059C5 5.00155 7.00155 3 9.47059 3H19.5294C21.9984 3 24 5.00155 24 7.47059V20.8824C24 23.3514 21.9984 25.3529 19.5294 25.3529H9.47059C7.00155 25.3529 5 23.3514 5 20.8824V7.47059ZM17.3647 11.9413V16.5521H18.296V14.8589H20.2823V13.9992H18.296V12.8074H20.647V11.9413H17.3647ZM12.6076 16.5521V11.9413H14.3464C14.8284 11.9413 15.2386 12.0325 15.5773 12.2148C15.9203 12.3971 16.1808 12.6598 16.3588 13.0028C16.5411 13.3458 16.6323 13.7648 16.6323 14.2597C16.6323 14.746 16.5433 15.1606 16.3653 15.5036C16.1916 15.8422 15.9355 16.1027 15.5968 16.2851C15.2582 16.4631 14.8435 16.5521 14.3529 16.5521H12.6076ZM13.5389 15.6924H14.3464C14.6677 15.6924 14.926 15.6317 15.1214 15.5101C15.3168 15.3885 15.4601 15.2192 15.5512 15.0021C15.6424 14.785 15.688 14.5354 15.688 14.2532C15.688 13.9797 15.6424 13.7344 15.5512 13.5173C15.4644 13.2959 15.3211 13.1222 15.1214 12.9963C14.926 12.8704 14.6612 12.8074 14.3269 12.8074H13.5389V15.6924ZM8.35294 11.9412V16.552H9.28422V15.1648H10.0787C10.4261 15.1648 10.7365 15.1062 11.01 14.989C11.2835 14.8674 11.4985 14.6851 11.6547 14.442C11.8154 14.1988 11.8957 13.8971 11.8957 13.5367C11.8957 13.1503 11.8241 12.8421 11.6808 12.612C11.5375 12.3775 11.3335 12.2082 11.0686 12.104C10.8081 11.9954 10.502 11.9412 10.1504 11.9412H8.35294ZM10.0657 14.3312H9.28422V12.8073H10.1113C10.4109 12.8073 10.628 12.8681 10.7625 12.9897C10.9015 13.1112 10.9709 13.2914 10.9709 13.5302C10.9709 13.7994 10.8885 14.0013 10.7235 14.1359C10.5628 14.2661 10.3436 14.3312 10.0657 14.3312Z"
                          fill="black"
                    />
                  </svg>
                  ИСО 9001-2015
                </a>
                <a href="https://smkis.ru/pdf/permits/iso_14001-2016.pdf"
                   class="aside-menu__item"
                   target="_blank"
                >
                  <svg width="28"
                ...
                <a href="https://smkis.ru/pdf/permits/iso_45001-2018.pdf"
                   class="aside-menu__item"
                   target="_blank"
                >
                  <svg width="28"
                ...
                <a href="https://smkis.ru/pdf/permits/sro_building.pdf"
                   class="aside-menu__item"
                   target="_blank"
                >
                  <svg width="28"
                ...
                <a href="https://smkis.ru/pdf/permits/sro_engineering.pdf"
                   class="aside-menu__item"
                   target="_blank"
                >
                  <svg width="28"
        ...
        <main class="page__main">
          <div class="engineering">
            <div class="engineering__menu">
              <div class="engineering-menu swiper">
                <div class="swiper-wrapper">
                  <a href="/"
                     class="engineering-menu__item swiper-slide active"
                  >Все анкерные устройства
                  </a>
                  <a href="/"
                     class="engineering-menu__item swiper-slide"
                  >Анкерная линия VIRA
                  </a>
                  <a href="/"
                     class="engineering-menu__item swiper-slide"
            ...
            <div class="engineering__items">
              <? component('engineering-items', [], 'src/data/engineering-items.json') ?>
            </div>
            <div class="page__aside-mobile">
              <div class="aside-mobile">
                <div class="aside-mobile__menu">
                  <div class="aside-menu"
                       data-type="2"
                  >
                    <a href="https://smkis.ru/pdf/permits/iso_9001-2015.pdf"
