...
<div class="page">
  ...
  <div class="page__title">
    <div class="container-inner">
      <h1 class="title h2">Жесткие анкерные линии на ж/д эстакаде Прибрежного склада нефтепродуктов</h1>
    </div>
  </div>
  <div class="page__border">
    <div class="container-inner">
      <div class="page__grid">
        ...
        <main class="page__main project">
          <div class="page__content">
            <div class="content">
              <h6>Задача</h6>
              <p class="h7">Обеспечить безопасный выход на вагон при сливе поставляемых на склад светлых
                            нефтепродуктов.
              </p>
              <p>Слив нефтепродуктов производится закрытым способом через нижние сливные устройства цистерн при помощи
                 центробежных насосов GA-211, GA-212 и GA-213. Для разгрузки цистерн с неисправным сливным прибором
                 предусмотрена возможность разгрузки через горловину загрузочного люка котла цистерн.
              </p>
              <h6>Решение</h6>
              <p class="h7">На эстакаде предусмотрена установка жёстких горизонтальных анкерных линий КАМА, которые
                            представляет собой анкерное устройство класса D, соответствующее требованиям ТР ТС 019/2011.
              </p>
              <p>Анкерные линии крепятся к нижним поясам существующих металлических односкатных ферм при помощи обжимных
                 пластин, исключая сверловку конструкций и проведения сварочных работ на территории предприятия.
              </p>
              <h6>Состав страховочной системы</h6>
              <p>Подробная техническая информация об анкерном устройстве, используемом в данном проекте, указана в
                 карточке ниже. Также в проекте использовались средство защиты втягивающего типа и страховочная привязь.
              </p>
            </div>
          </div>
    ...
    <span class="catalog-item__img">
      <img src="/upload/images/catalog-items/1.jpg"
           width="498"
           height="556"
    ...
    <span class="catalog-item__look btn-play">
     ...
     <span class="catalog-item__name h7">Временная анкерная линия</span>
     <span class="catalog-item__price h7">47 000 ₽</span>
     <span class="catalog-item__category caption">CROSS LINE</span>
   </span>
              </a>
            </div>
            <div class="project__item">
              <a href="/catalog/product/" class="catalog-item">
                <span class="catalog-item__top">
    <span class="catalog-item__img">
      <img src="/upload/images/catalog-items/2.jpg" width="498" height="556" alt="Анкерный столбик" loading="lazy">
    </span>
    <span class="catalog-item__look btn-play">
     Смотреть
   </span>
                ...
                <span class="catalog-item__info">
     <span class="catalog-item__name h7">Анкерный столбик</span>
     <span class="catalog-item__price h7">18 000 ₽</span>
     <span class="catalog-item__category caption">BASC</span>
   </span>
              </a>
            </div>
          </div>
          <div class="project__gallery">
            <div class="product-photos">
              ...
              <div class="product-photos__imgs">
                <a href="/upload/images/product/photo.webp" class="product-photos__img" data-fancybox="gallery">
                  <img src="/upload/images/product/photo.webp" width="2048" height="1365" alt="на объектах" loading="lazy">
                </a>
                <a href="/upload/images/product/photo.webp" class="product-photos__img" data-fancybox="gallery">
                  <img src="/upload/images/product/photo.webp" width="2048" height="1365" alt="на объектах" loading="lazy">
                </a>
              ...
              <a href="/" class="product-photos__all btn btn--large btn--border">
                Все фото
              </a>
            </div>
          </div>
